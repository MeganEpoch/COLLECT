 ...
 * 推荐使用词形词序句子相似度：org.xm.similarity.text.CosineSimilarity，
 * 一种考虑两个段落中相同的文本，经过切词，词频和词性权重加权，并用余弦计算相似度的方法
 */
...
public class CosineSimilarity extends TextSimilarity {
     ...
     */
    @Override
    public double getSimilarityImpl(List<org.xm.tokenizer.Word> words1, List<org.xm.tokenizer.Word> words2) {
        // 词频标注词的权重
        ...
        words.addAll(words1);
        words.addAll(words2);
        org.xm.similarity.util.AtomicFloat ab = new org.xm.similarity.util.AtomicFloat();// a.b
        org.xm.similarity.util.AtomicFloat aa = new org.xm.similarity.util.AtomicFloat();// |a|的平方
        org.xm.similarity.util.AtomicFloat bb = new AtomicFloat();// |b|的平方
        // 计算
